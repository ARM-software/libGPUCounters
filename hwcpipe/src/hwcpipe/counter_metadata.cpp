...
constexpr std::array<counter_metadata, 365> all_counter_metadata{
    ...
    counter_metadata{"Fragment read primitives", "primitives"},
    ...
    counter_metadata{"Fragment job descriptor read wait cycles", "cycles"},
    counter_metadata{"Fragment job issue wait cycles", "cycles"},
    counter_metadata{"Fragment job dependency wait cycles", "cycles"},
    counter_metadata{"Fragment job finish wait cycles", "cycles"},
    counter_metadata{"Non-fragment job descriptor read wait cycles", "cycles"},
    counter_metadata{"Non-fragment job issue wait cycles", "cycles"},
    counter_metadata{"Non-fragment job dependency wait cycles", "cycles"},
    counter_metadata{"Non-fragment job finish wait cycles", "cycles"},
    counter_metadata{"Reserved job descriptor read wait cycles", "cycles"},
    counter_metadata{"Reserved job issue wait cycles", "cycles"},
    counter_metadata{"Reserved job dependency wait cycles", "cycles"},
    counter_metadata{"Reserved job finish wait cycles", "cycles"},
    ...
    counter_metadata{"Fragment cache flush wait cycles", "cycles"},
    counter_metadata{"Non-fragment cache flush wait cycles", "cycles"},
    counter_metadata{"Reserved cache flush wait cycles", "cycles"},
    ...
    counter_metadata{"GPU interrupt count", "issues"},
    ...
    counter_metadata{"Vertex IRQ active", "cycles"},
    counter_metadata{"Vertex endpoint stall cycles", "cycles"},
    counter_metadata{"Vertex endpoint drain stall cycles", "cycles"},
    ...
    counter_metadata{"Command stream 0 wait stall", "cycles"},
    counter_metadata{"Command stream 1 active", "cycles"},
    counter_metadata{"Command stream 1 wait stall", "cycles"},
    counter_metadata{"Command stream 2 active", "cycles"},
    counter_metadata{"Command stream 2 wait stall", "cycles"},
    counter_metadata{"Command stream 3 active", "cycles"},
    counter_metadata{"Command stream 3 wait stall", "cycles"},
