...
typedef enum hwcpipe_counter {
    ...
    MaliGPUIterActiveCy,
    MaliGPUIRQCount,
    MaliL2CacheFlushCycles,
    MaliVertIterQueuedCy,
    MaliIterVertJob,
    MaliIterVertTask,
    MaliIterVertTotalActive,
    MaliIterVertIRQActive,
    MaliVertIterAssignStallCy,
    MaliIterTilerDrainStall,
    MaliCompIterQueuedCy,
    MaliIterCompJob,
    MaliIterCompTask,
    MaliIterCompTotalActive,
    MaliIterCompIRQActive,
    MaliCompIterAssignStallCy,
    MaliIterCompDrainStall,
    MaliFragIterQueuedCy,
    MaliIterFragJob,
    MaliIterFragTotalActive,
    MaliIterFragIRQActive,
    ...
    MaliMainPhaseIterActiveCy,
    MaliMainPhaseIterUtil,
    MaliBinPhaseIterActiveCy,
    MaliBinPhaseIterUtil,
